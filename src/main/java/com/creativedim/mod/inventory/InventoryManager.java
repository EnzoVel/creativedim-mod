...
public class InventoryManager {
    ...
    public void onTravelToDimension(EntityTravelToDimensionEvent event) {
        ...
        if (enteringCreative) {
            ...
            CosmeticArmourHelper.saveForNormal(player);
            ...
            CosmeticArmourHelper.saveForCreative(player);
    ...
    public void onChangedDimension(PlayerEvent.PlayerChangedDimensionEvent event) {
        ...
        if (enteredCreative) {
            ...
            CosmeticArmourHelper.restoreForCreative(player);
            ...
            CosmeticArmourHelper.restoreForNormal(player);
